var g_MainMenuItems = [
	{
		...
		"submenu": [
			...
			{
				"caption": translate("Technology Tree"),
				"tooltip": colorizeHotkey(translate("%(hotkey)s: View the technology tree of civilizations featured in 0 A.D."), "techtree"),
				"hotkey": "techtree",
				"onPress": () => {
					let callback = data => {
						if (data.nextPage)
					...
					Engine.PushGuiPage("page_techtree.xml", {}, callback);
				},
			},
			{
